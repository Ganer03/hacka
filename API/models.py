...
# Арендатор
class Leaser(User):
    address = models.CharField(verbose_name="Юр.адрес", max_length=120, default="г.Москва ул.Кутузова, 119")
    company_name = models.CharField(verbose_name="Название юр.лица", max_length=60, default="ООО СтройИнвест")
    transfers = models.ManyToManyField(Transfer, blank=True)
    password = models.CharField(verbose_name="Пароль", max_length=60)
    phone = models.CharField(verbose_name='Телефон', max_length=15, default=True)
...
class Building(TimeMixin):
    photo_build = models.FileField(verbose_name='photo', null=True, upload_to="buildings")
...
class CommercialObject(TimeMixin):
    ...
    photo_com_obj = models.FileField(verbose_name='photo', null=True, upload_to="buildings")
